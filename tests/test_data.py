...
class TestPatient:
    ...
    def test_patient_name(self, tmp_path: Path):
    ...
    def test_patient_dir(self, tmp_path: Path):
    ...
    def test_get_patient_number_single_digit(self, tmp_path: Path):
    ...
    def test_get_patient_number_multiple_digits(self, tmp_path: Path):
    ...
    def test_get_patient_number_no_digits(self, tmp_path: Path):
    ...
    def test_get_patient_number_mixed_format(self, tmp_path: Path):
    ...
    def test_get_patient_number_first_number_only(self, tmp_path: Path):
    ...
    def test_ct_path(self, tmp_path: Path):
    ...
    def test_mask_destination(self, tmp_path: Path):
    ...
    def test_struct_path(self, tmp_path: Path):
    ...
    def test_downsampled_destination(self, tmp_path: Path):
    ...
    def test_downsampled_destination_complex_path(self, tmp_path: Path):
...
class TestAllPatients:
    ...
    def test_all_patients_initialization(self, tmp_path: Path):
    ...
    def test_get_patients_finds_all_patient_dirs(self, tmp_path: Path):
    ...
    def test_get_patients_empty_directory(self, tmp_path: Path):
    ...
    def test_sorted_by_number_ascending_order(self, tmp_path: Path):
    ...
    def test_sorted_by_number_mixed_format(self, tmp_path: Path):
    ...
    def test_sorted_by_number_with_non_numeric(self, tmp_path: Path):
    ...
    def test_patients_property_returns_list(self, tmp_path: Path):
    ...
    def test_single_patient(self, tmp_path: Path):
    ...
    def test_many_patients(self, tmp_path: Path):
...
class TestIntegration:
    ...
    def test_patient_properties_in_all_patients(self, tmp_path: Path):
    ...
    def test_workflow_with_multiple_patients(self, tmp_path: Path):
